//包含多个接口请求函数的模块  函数的返回值：promise对象
...
//const reqShops = (a,b) => ajax('/shops',{longitude:a,latitude:b})
...
export const reqAddress = (name, pwd, captcha) => ajax('/login_pwd', { name, pwd, captcha }, post)
...
export const reqAddress = (phone, code) => ajax('/login_sms', { phone, code }, post)
